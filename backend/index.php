            ...
            <div class="row">
                    ...
                    <div class="sidebar bg-light p-3">
                        ...
                        <ul class="list-group">
                            <?php if (empty($categories)): ?>
                                <li class="list-group-item">Have no category!</li>
                            <?php else: ?>
                                ...
                                <?php endforeach; ?>
                            <?php endif; ?>
                            <li class="list-group-item"><a href="#category-0">Other Products</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    ...
                    <?php if (empty($products_by_category)): ?>
                        <p class="text-center">There is no product in storage</p>
                    <?php else: ?>
                                        ...
                                        <div class="col-md-4" style = "height: 450px;">         
                                            <div class="card mb-4 ">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <a href="product_detail.php?product_id=<?php echo $product['product_id']; ?>" class="btn btn-info">View detail</a>
                                                </div>
                                            </div>
                                        </div>  
                                    <?php endforeach; ?>
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            ...
            .then(data => {
                if (data.status === 'success') {
                    ...
                    alert('Products have been add to cart!');
                } else {
                    alert(data.message);
                }
            })
            .catch(error => {
                ...
                alert('An erro when add to cart!');
            });
        <?php else: ?>
